...
public abstract class AbstractBinaryOperation implements expression.CustomExpression {
    private final expression.CustomExpression value1;
    private final expression.CustomExpression value2;

    public AbstractBinaryOperation(expression.CustomExpression value1, CustomExpression value2) {
        this.value1 = value1;
        this.value2 = value2;
    }
